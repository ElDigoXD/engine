...
namespace math
{
    ...
    {
        const tt::Vector2 a{ 2.0f, 3.0f };
        const tt::Vector2 b{ 4.0f, 5.0f };
    ...
    {
        const tt::Vector2 a{ 4.0f, 4.0f };

        const tt::Vector2 result = a.sqrt();

        CHECK(result == tt::Vector2{ 2.0f, 2.0f });
    }

    TEST_CASE("Vector2f addition", "[Vector2]")
    {
        const tt::Vector2 a{ 1.0f, 2.0f };
        const tt::Vector2 b{ 3.0f, 4.0f };

        const tt::Vector2 result = a + b;
    ...
    {
        const tt::Vector2 a{ 5.0f, 7.0f };
        const tt::Vector2 b{ 2.0f, 3.0f };
    ...
    TEST_CASE("Vector2f scalar multiplication", "[Vector2]")
    {
        ...
        const tt::Vector2 result = v * 2.0f;
    ...
    {
        const tt::Vector2 a{ 1.0f, 2.0f };
        const tt::Vector2 b{ 1.0000012315f, 2.00000123123f };
